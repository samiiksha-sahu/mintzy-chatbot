...
const KNOWN_TOPICS = {
  ...
  ticker: "apiDocs.txt",
  "make prediction": "apiDocs.txt",
  "make predictions": "apiDocs.txt",
  "get_prediction": "apiDocs.txt",
  "get prediction": "apiDocs.txt",
  "how to predict": "apiDocs.txt",
  "prediction code": "apiDocs.txt",
  "predict code": "apiDocs.txt",
  founder: "about.txt",
  founders: "about.txt",
  mission: "about.txt",
  vision: "about.txt",
